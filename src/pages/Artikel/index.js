...
const Artikel = (props) => {
    ...
    data.map(data => {
        data.user == "Jepri Kusuma" && dataUser.push(data);
        data.saved.includes(1) && dataSaved.push(data);
    })
            ...
            onContentSizeChange={() => toPage(windowWidth - 20)}
             >
                <ScrollView style={styles.listArtikel}>
                    <LayoutArtikel theme = {props.theme} data = {dataUser}/>
                </ScrollView>
                <ScrollView style={styles.listArtikel}>
                    <LayoutArtikel theme = {props.theme} data = {data}/>
                </ScrollView>
                <ScrollView style={styles.listArtikel}>
                    <LayoutArtikel theme = {props.theme} data = {dataSaved}/>
                </ScrollView>
            </ScrollView>
            {/* Add */}
